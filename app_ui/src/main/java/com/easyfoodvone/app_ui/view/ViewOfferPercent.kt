...
import com.easyfoodvone.app_ui.binding.UIVariationNewOfferPercent
import com.easyfoodvone.app_ui.databinding.PageOffersPercentDiscountBinding
import com.easyfoodvone.app_ui.databinding.PageOffersPercentDiscountPhoneBinding

class ViewOfferPercent(
    private val lifecycle: LifecycleSafe,
    private val context: FragmentActivity,
    private val isPhone: Boolean,
    private val data: DataPageNewOffer.PagePercent) {

    private var ui: UIVariationNewOfferPercent<*>? = null
    ...
    fun onCreateView(inflater: LayoutInflater, container: ViewGroup?) {
        ui = if (isPhone) {
            UIVariationNewOfferPercent.Phone(PageOffersPercentDiscountPhoneBinding.inflate(inflater, container, false))
        } else {
            UIVariationNewOfferPercent.Tablet(PageOffersPercentDiscountBinding.inflate(inflater, container, false))
    ...
    private val inputEventHandler = object : DataPageNewOffer.PagePercent.InputEvents {
