...
import com.easyfoodvone.app_ui.databinding.PageOffersPercentDiscountPhoneBinding as PhoneType
import com.easyfoodvone.app_ui.databinding.PageOffersPercentDiscountBinding as TabletType

sealed class UIVariationNewOfferPercent<T : ViewDataBinding> {
    ...
    abstract fun setData(data: DataPageNewOffer.PagePercent, lifecycle: LifecycleSafe)

    class Phone(override val binding: PhoneType) : UIVariationNewOfferPercent<PhoneType>() {
        ...
        override fun setData(data: DataPageNewOffer.PagePercent, lifecycle: LifecycleSafe) {
            binding.data = data
            lifecycle.unbindOnDestroy(::binding)
        }
    }

    class Tablet(override val binding: TabletType) : UIVariationNewOfferPercent<TabletType>() {
        override val imageTop = binding.imageTop
        override val editOfferTitle = binding.editOfferTitle
        // override val offerDescripton = binding.offerDescripton
        override val editDiscountAmount = binding.editDiscountAmount
